        ...
        return Card(
          ...
          child: ListTile(
            ...
            subtitle: Text(
              ...
              maxLines: 2, // Limita las líneas en caso de contenido largo
              overflow: TextOverflow.ellipsis, // Agrega puntos suspensivos al desbordarse
            ),
            trailing: Row(
              ...
              children: [
                IconButton(
                  ...
                  onPressed: () {
                    // Implementa la funcionalidad para generar el PDF o mostrar un diálogo.
                    showDialog(
                      context: context,
